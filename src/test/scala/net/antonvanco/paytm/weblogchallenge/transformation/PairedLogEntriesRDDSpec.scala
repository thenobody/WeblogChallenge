...
class PairedLogEntriesRDDSpec extends FlatSpec with Matchers with SparkContextLoan {
  ...
  it should "resolve session IDs for LogEntries" in withSparkContext(sparkConf) { sparkContext =>
    ...
    val inputRdd = sparkContext.parallelize(Seq(
      "127.0.0.1:8080" -> new LogEntry(currentMillis, "127.0.0.1:8080", new URI("https://localhost:1234/page1"), "UserAgent"),
      "127.0.0.1:8080" -> new LogEntry(currentMillis + 1000, "127.0.0.1:8080", new URI("https://localhost:1234/page2"), "UserAgent"),
      "127.0.0.1:8080" -> new LogEntry(currentMillis + sessionTimeoutMillis + 1000, "127.0.0.1:8080", new URI("https://localhost:1234/page3"), "UserAgent"),
      "127.0.0.1:8080" -> new LogEntry(currentMillis + sessionTimeoutMillis + 2000, "127.0.0.1:8080", new URI("https://localhost:1234/page4"), "UserAgent"),

      "127.0.0.2:8080" -> new LogEntry(currentMillis, "127.0.0.2:8080", new URI("https://localhost:1234/page1"), "UserAgent"),
      "127.0.0.2:8080" -> new LogEntry(currentMillis + sessionTimeoutMillis + 1000, "127.0.0.2:8080", new URI("https://localhost:1234/page3"), "UserAgent"),
      "127.0.0.2:8080" -> new LogEntry(currentMillis + 2 * sessionTimeoutMillis + 1000, "127.0.0.2:8080", new URI("https://localhost:1234/page4"), "UserAgent")
    ))

    val expResult = Seq(
      ("127.0.0.1:8080", 1) -> new LogEntry(currentMillis, "127.0.0.1:8080", new URI("https://localhost:1234/page1"), "UserAgent"),
      ("127.0.0.1:8080", 1) -> new LogEntry(currentMillis + 1000, "127.0.0.1:8080", new URI("https://localhost:1234/page2"), "UserAgent"),
      ("127.0.0.1:8080", 2) -> new LogEntry(currentMillis + sessionTimeoutMillis + 1000, "127.0.0.1:8080", new URI("https://localhost:1234/page3"), "UserAgent"),
      ("127.0.0.1:8080", 2) -> new LogEntry(currentMillis + sessionTimeoutMillis + 2000, "127.0.0.1:8080", new URI("https://localhost:1234/page4"), "UserAgent"),

      ("127.0.0.2:8080", 1) -> new LogEntry(currentMillis, "127.0.0.2:8080", new URI("https://localhost:1234/page1"), "UserAgent"),
      ("127.0.0.2:8080", 2) -> new LogEntry(currentMillis + sessionTimeoutMillis + 1000, "127.0.0.2:8080", new URI("https://localhost:1234/page3"), "UserAgent"),
      ("127.0.0.2:8080", 3) -> new LogEntry(currentMillis + 2 * sessionTimeoutMillis + 1000, "127.0.0.2:8080", new URI("https://localhost:1234/page4"), "UserAgent")
    )
